...
from datastore.tests.helpers import extract
...
class TestDatastoreSearch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_records = [{u'published': u'2005-03-01T00:00:00',
                                 u'_id': 1,
...
class TestDatastoreFullTextSearch(unittest.TestCase):
...
class TestDatastoreSQL(unittest.TestCase):
